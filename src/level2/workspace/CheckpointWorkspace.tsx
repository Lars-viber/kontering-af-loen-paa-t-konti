...
import { YtdSpecificationDialog } from './YtdSpecificationDialog';
  ...
  return <main className="l2-phase-workspace l2-checkpoint-workspace">
    ...
    <header className="l2-phase-intro">
      ...
      <div className="l2-phase-progress"><strong>{correctCount} af 5 korrekte</strong>
        <button type="button" onClick={() => setSpecificationOpen(true)}>Vis ÅTD-specifikation</button></div>
    </header>
    ...
    {specificationOpen && <YtdSpecificationDialog
